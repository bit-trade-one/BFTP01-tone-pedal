...
//                if(USBActiveConfiguration == 1)
                    ...
                    case 2:
                    	USBEP0SendROMPtr(
	                        (ROM BYTE*)&configDescriptor1 + 18+9+7+9 + 9+7+7+9,		// magic number.  It is the offset from start of the configuration descriptor to the start of the HID descriptor.
	                        sizeof(USB_HID_DSC)+3,
	                        USB_EP0_INCLUDE_ZERO);
	                    break;
                    ...
                    case 3:
                    	USBEP0SendROMPtr(
	                        (ROM BYTE*)&configDescriptor1 + 18+9+7+9 + 9+7+7+9 + 9+7+7+9,		// magic number.  It is the offset from start of the configuration descriptor to the start of the HID descriptor.
	                        sizeof(USB_HID_DSC)+3,
	                        USB_EP0_INCLUDE_ZERO);
	                    break;
